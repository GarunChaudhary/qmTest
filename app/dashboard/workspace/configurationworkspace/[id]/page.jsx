...
export default function SettingsPage({ params }) {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (response.ok && result.success) {
        router.push(`/dashboard/workspace/column-mapping/${id}`);
        setToast(true);
  ...
  const handleReset = () => {
    setForm({
      orgId: "", intervalInMinute: "", tokenUrl: "", clientId: "", clientSecret: "",
      redirectUri: "", baseUrl: "", token: "", tokenExpiresInSeconds: "",
      refreshToken: "", refreshTokenExpiresInSec: "", timezone: "",
      destDirectory: "", fileFormat: "", folderStructure: "", workspaceid: id,
    });
    setErrors({});
  };
